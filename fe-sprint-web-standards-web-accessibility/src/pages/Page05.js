            ...
            <section>
                ...
                <section>
                    ...
                    <div className="iconButtonContainer">
                        <button aria-label="home"className="iconButton"><img src={home} /></button>
                        <button aria-label="web"className="iconButton"><img src={web} /></button>
                        <button aria-label="mail"className="iconButton"><img src={mail} /></button>
                    </div>
                </section>
