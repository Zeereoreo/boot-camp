        ...
        <article>
            ...
            <section>
                ...
                <section>
                    <h1>예시 3</h1>
                    <li>
                        <div>글씨 크기를 조절하고 싶을 땐</div>
                    </li>
                    <li>
                        <div>요소 종류를 사용하는 것이 아니라</div>
                    </li>
                    <li>
                        <div>CSS를 이용해주세요.</div>
                    </li>
                    <li>
                        <div>요소의 의미와 맞지 않습니다.</div>
                    </li>
                </section>
                <section>
                    <h3>예시 4</h3>
                ...
                <section>
                    <h3>종합 예시</h3> 
                    <a>
                        <li className="li-style"><strong>위 예시를 종합적으로 섞어놓았습니다.</strong></li>
                        <br />
                        
                            <div className="back-color"><strong>이 정도 되면 보기만해도 불편하실 것 같습니다.</strong></div>
                            <br /> 
                        
                        <h1 className="h-style"><em>틀린 곳을 찾아서 수정해보세요.</em></h1>
                    </a>
                </section>
            </section>
        </article>)
